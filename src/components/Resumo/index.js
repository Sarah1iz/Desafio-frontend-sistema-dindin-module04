            ...
            <div className='content_resumo'>
                ...
                <div className='container_transacoes'>
                    <div className='entradas'>
                        ...
                        <p className='transacoes_entradas'>R${(valorResumo.entrada / 100).toFixed(2)}</p>
                    </div>

                    <div className='saidas'>
                        <p className='transacoes_titulo'>Saídas</p>
                        <p className='transacoes_saidas'>R${(valorResumo.saida / 100).toFixed(2)}</p>
                    </div>

                    <div className='resumo_saldo'>
                        <h3 className='saldo_titulo'>Saldo</h3>
                        <p className='saldo'>R${(valorResumo.saldo / 100).toFixed(2)}</p>
                    </div>
                </div>
            </div>
